  ...
  guide: {
    ...
    registryGenerator: {
      ...
      group: {
        ...
        mainTypingArea: 'Zona principal de escritura',
        functionKeys: 'Teclas de función',
        numpad: 'Teclado numérico',
      },
      key: {
        turnOff: 'Desactivar tecla',
        escape: 'Escape',
        tab: 'Tab',
        backspace: 'Retroceso',
        enter: 'Enter',
        ...
        hangulEnglish: 'Hangul / inglés',
        hanja: 'Hanja',
        katakanaHiragana: 'Katakana / Hiragana',
        henkan: 'Convertir',
        muhenkan: 'Sin conversión',
        zenkakuHankaku: 'Ancho completo / medio ancho',
        leftWin: 'Windows izquierdo',
        rightWin: 'Windows derecho',
        menu: 'Menú',
        insert: 'Insert',
        delete: 'Supr',
        home: 'Inicio',
        ...
        numpadEnter: 'Enter del teclado numérico',
    ...
    hardware: {
      ...
      methodsTitle: 'Métodos de configuración',
      advantages: {
      ...
      sections: {
        ...
        tools: {
          ...
          body2:
            'Algunas de estas herramientas funcionan sobre firmware propio del fabricante, pero hoy en día muchas se apoyan en firmware abierto como QMK, VIA, Vial o ZMK.',
          body3: '',
        },
      },
      references: {
