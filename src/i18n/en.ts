    ...
    platforms: [
      ...
      },
      {
        ...
        notes: [
          ...
          'Apple also documents a built-in option to use [[Caps Lock]] to switch to and from the last used Latin input source. The [[Right Command]] -> [[F18]] route is useful when you want to keep language switching available without sacrificing your [[Caps Lock]] remap.',
          sharedGuideCopy.en.keepCapsLockNote,
        ],
        placeholder: '',
      },
